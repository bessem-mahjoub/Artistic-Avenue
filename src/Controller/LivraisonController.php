...
class LivraisonController extends AbstractController
{
    ...
    #[Route('/{idLiv}', name: 'app_livraison_show', methods: ['GET'])]
    ...
    #[Route('/{idLiv}/edit', name: 'app_livraison_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idLiv}', name: 'app_livraison_delete', methods: ['POST'])]
